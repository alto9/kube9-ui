...
- Example: `fix: resolve navigation issue`
...
- Example: `feat: redesign entire UI framework #major`
...
- Git tags - `git tag -l`
- GitHub Releases - https://github.com/alto9/kube9-ui/releases

## Examples

```bash
# Patch bump (0.0.1 → 0.0.2)
git commit -m "fix: correct dashboard refresh"

# Minor bump (0.0.1 → 0.1.0)
git commit -m "feat: add multi-cluster support #minor"
